...
<section id="cta-section"
    ...
    <div class="absolute inset-0 opacity-25 pointer-events-none">
        <div class="top-4 left-6 absolute bg-[#FCE77C] rounded-full w-2 h-2 animate-ping"></div>
        <div class="top-12 right-12 absolute bg-[#ED865A] rounded-full w-1 h-1 animate-bounce"></div>
    ...
    <div class="z-10 relative flex lg:flex-row flex-col justify-center items-center gap-8 lg:gap-12 mx-auto px-6 max-w-6xl">
        ...
        <!-- CTA Box -->
        <div class="z-20 relative flex-1 bg-white/15 shadow-xl hover:shadow-2xl backdrop-blur-md p-6 md:p-8 lg:p-10 border border-[#FCE77C]/30 rounded-xl w-full lg:max-w-4xl text-left hover:scale-[1.02] transition-all hover:-translate-y-1 duration-700 transform">

            <!-- Decorative icon -->
            <div class="-top-3 left-1/2 absolute flex justify-center items-center bg-[#FCE77C] shadow-lg rounded-full w-8 h-8 -translate-x-1/2">
                <svg class="w-4 h-4 text-[#514D4D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if (!empty($sub)): ?>
                <p class="opacity-95 hover:opacity-100 mb-5 text-[#FCE77C] text-base md:text-lg leading-relaxed transition duration-500">
                    <?= esc($sub) ?>
                </p>
            <?php endif; ?>
        ...
        <div class="z-10 flex flex-1 justify-center lg:justify-start items-center opacity-0 motion-safe:opacity-100 mt-6 lg:mt-0 w-full transition-all translate-y-6 motion-safe:translate-y-0 duration-[1200ms] ease-out delay-300">
            <img src="https://www.books4people.co.uk/cdn/shop/products/japan1_800x.jpg?v=1637076003"
                alt="BooksInARow"
